...
\thusetup{
  ...
  %   可使用“\\”命令手动控制换行
  %
  title  = {基于计算机视觉和深度学习算法的风机\\叶片损伤检测研究},
  title* = {Research on damage detection of wind turbine blade based on computer vision and deep learning},
  %
  % 学位
  %   1. 学术型
  %      - 中文
...
%   department* = {School of Civil Engineering},
  ...
  %
  % 指导教师
  %   中文姓名和职称之间以“\hspace{1bp}”分开，下同
  %
  supervisor  = {曹金凤 \hspace{1bp} 副教授},
